...
exports.listen = function (options, transportUtil) {
  return function (msg, callback) {
    ...
    var listen_details = seneca.util.deep(msg)
...
exports.client = function (options, transportUtil) {
  return function (msg, callback) {
    ...
    if (options[msg.type].headers) {
      defaultHeaders = Omit(options[msg.type].headers, [
        'Accept',
        'Content-Type',
        'Content-Length',
        'Cache-Control',
	...
	// aggiungo chiave ca se presente per validazione server
        if (clientOptions.clientOptions.ca) {
          requestOptions.ca = clientOptions.clientOptions.ca;
        }
  ...
  req.on('end', function () {
    try {
      ...
      req.body = Object.assign(
        ...
        // deprecated
        req.query && req.query.args$ ? seneca.util.Jsonic(req.query.args$) : {},

        req.query && req.query.msg$ ? seneca.util.Jsonic(req.query.msg$) : {},
        req.query || {},
      )
